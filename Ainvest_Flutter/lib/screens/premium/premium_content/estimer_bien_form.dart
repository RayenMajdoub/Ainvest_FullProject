...
class EstimerBienForm extends StatefulWidget {
  const EstimerBienForm({super.key});

  @override
  State<EstimerBienForm> createState() => _EstimerBienFormState();
}

class _EstimerBienFormState extends State<EstimerBienForm> {
  int _processIndex = 0;
  ...
  List<Step> stepList() => [
        ...
        /*   Step(
            ...
            title: const Text("Etage"),
            content: Column(children: [
              text_filed_with_title(
                  "Combien y a-t-il d'étages dans votre immeuble ", _nbrEtage),
              text_filed_with_title("à quel étage êtes vous ?", _surQuelleEtage)
            ])),
        Step(
