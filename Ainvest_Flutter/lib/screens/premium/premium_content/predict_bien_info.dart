...
class PredictBienPage extends StatefulWidget {
  const PredictBienPage({super.key});

  @override
  State<PredictBienPage> createState() => _PredictBienPageState();
}

class _PredictBienPageState extends State<PredictBienPage> {
    ...
    switch (_selectedIndex) {
      case 1:
        return Responsive.isDesktop(context)
            ? SizedBox(height: 900, width: 1000, child: PredictBienForm())
            : SizedBox(
                height: SizeConfig.screenHeight,
                width: SizeConfig.screenWidth,
                child: PredictBienForm());
